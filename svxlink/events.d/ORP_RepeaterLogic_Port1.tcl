...
###############################################################################
#
# ORP_RepeaterLogic_Port1 event handlers
#
###############################################################################

#
# This is the namespace in which all functions below will exist. The name
# must match the corresponding section "[ORP_RepeaterLogic_Port1]" in the configuration
# file. The name may be changed but it must be changed in both places.
#
namespace eval ORP_RepeaterLogic_Port1 {
